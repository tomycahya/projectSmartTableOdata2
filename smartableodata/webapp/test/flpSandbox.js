		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "smartableodata",
									"targetURL": "#smartableodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartableodata-display": {
								"semanticObject": "smartableodata",
								"action": "display",
								"description": "smartableodata",
								"title": "smartableodata",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartableodata",
									"url": sap.ui.require.toUrl("smartableodata")
								}
							}
						}
					}
